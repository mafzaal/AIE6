...
### Adding the AIE6 Repository as an "Upstream Remote"
...
```bash
git remote add upstream git@github.com:AI-Maker-Space/AIE6.git
```
...
```
origin  git@github.com:chris-alexiuk/AIE6.git (fetch)
origin  git@github.com:chris-alexiuk/AIE6.git (push)
upstream        git@github.com:AI-Maker-Space/AIE6.git (fetch)
upstream        git@github.com:AI-Maker-Space/AIE6.git (push)
```
